...
public class HeadNewsBottomSheetFragment extends BottomSheetDialogFragment
{
    public static final String TAG = "HeadNewsBttmSheetFrgmt";
    private News mNews;
    private RealmHelper mHelper;

    public static HeadNewsBottomSheetFragment newInstance()
    {
        return new HeadNewsBottomSheetFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        View view = inflater.inflate(R.layout.head_news_bottom_sheet, container, false);
